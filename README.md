...
I build software and ship it.

**BookHub** is live — a hyperlocal book-sharing platform with a built-in AI assistant, built solo from scratch.
The **Farm Monitoring AI Machine** I co-designed holds a government-registered Design Patent (CGPDTM · No. 476772-001).
A **research paper** I co-authored has cleared peer review and is accepted for oral presentation.
...
Building. Available for full-stack or software development roles.
